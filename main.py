...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("📥 Send me a video link (YouTube, Vimeo, TikTok, Reddit, Terabox, etc.) and I will try to download it.")
...
async def on_startup():
    ...
    webhook_url = os.getenv("WEBHOOK_URL")  # ✅ define it properly here
